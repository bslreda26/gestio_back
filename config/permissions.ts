...
export const ROLE_PERMISSIONS = {
  ...
  clients_solde: ['admin', 'gerant', 'caissier', 'facturation'],
  ...
  ventes_ligne_remise: ['admin', 'gerant', 'facturation'],
  ventes_remise_totale: ['admin', 'gerant', 'facturation'],
  ventes_remise_montant: ['admin', 'gerant', 'facturation'],
