...
const shieldConfig = defineConfig({
  ...
  /**
   * CSRF is disabled intentionally: this API authenticates via Bearer
   * access tokens (Authorization header), not browser session cookies.
   * Re-enable if cookie-based session login is added for the SPA.
   */
  csrf: {
    /**
